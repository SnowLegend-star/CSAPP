...
00000000004013f9 <skip>:
  ...
  401401:	48 8d 3c 80          	lea    (%rax,%rax,4),%rdi         ;rdi=5*rax
  401405:	48 c1 e7 04          	shl    $0x4,%rdi                  ;rdi<<4
  401409:	48 81 c7 80 37 60 00 	add    $0x603780,%rdi             ;rdi是input_strings的起始地址dd
  401410:	48 8b 15 51 23 20 00 	mov    0x202351(%rip),%rdx        # 603768 <infile>
  401417:	be 50 00 00 00       	mov    $0x50,%esi                 ;esi=0x50
  40141c:	e8 5f f7 ff ff       	callq  400b80 <fgets@plt>         
  401421:	48 89 c3             	mov    %rax,%rbx                  ;rbx=rax
  401424:	48 85 c0             	test   %rax,%rax                  ;if(rax==0)
  401427:	74 0c                	je     401435 <skip+0x3c>         ;goto 401435 ret
  401429:	48 89 c7             	mov    %rax,%rdi                  ;else rdi=rax
...
000000000040149e <read_line>:
  40149e:	48 83 ec 08          	sub    $0x8,%rsp                        ;准备腾出空间
  4014a2:	b8 00 00 00 00       	mov    $0x0,%eax                        ;eax=0
